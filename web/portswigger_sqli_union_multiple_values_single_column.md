# PortSwigger SQL Injection — SQL injection UNION attack, retrieving multiple values in a single column
...
- Table/columns/channel: `single visible column`
- Key result: `l10r43e34n6wps48avqi`
