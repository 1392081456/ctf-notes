...
- **[portswigger_dom_based_series]** — `web/portswigger_dom_based_series.md` — PortSwigger DOM-based vulnerabilities 1-7 整合页 / web message source、DOM open redirect、cookie manipulation、DOM clobbering、sanitizer attributes clobbering
- **[portswigger_cors_series]** — `web/portswigger_cors_series.md` — PortSwigger CORS 1-3 整合页 / Origin 反射、trusted null Origin、trusted HTTP subdomain + XSS 读取主站 accountDetails
...
- **[portswigger_host_header_series]** — `web/portswigger_host_header_series.md` — PortSwigger HTTP Host Header Attacks 1-7 整合页 / reset poisoning、Host auth bypass、ambiguous cache poisoning、routing SSRF、connection-state、dangling markup
...
- **[portswigger_nosql_injection_series]** — `web/portswigger_nosql_injection_series.md` — PortSwigger NoSQL Injection 1-4 整合页 / MongoDB operator injection、boolean oracle、$where、unknown field extraction
- **[portswigger_api_testing_series]** — `web/portswigger_api_testing_series.md` — PortSwigger API Testing 1-5 整合页 / exposed docs、server-side parameter pollution、unused methods、mass assignment、REST URL pollution
